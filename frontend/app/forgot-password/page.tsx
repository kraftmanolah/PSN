...
//                 )}
//             </div>
//             <div className="w-full md:w-1/2 h-48 md:h-screen bg-cover bg-center order-2 md:order-2" style={{ backgroundImage: 'url("/images/forgot.png")' }} />
//         </div>
//     );
// }
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-8 bg-white relative order-1 md:order-1">
                <div className="w-full max-w-md space-y-4">
                    ...
                    <p className="text-sm text-gray-600 text-center">
                        <Link href="/signin" className="text-yellow-500 hover:text-yellow-600 underline">
                            Go back to Sign in
                        </Link>
                    </p>
                </div>
