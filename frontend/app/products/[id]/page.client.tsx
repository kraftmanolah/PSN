...
// import { faTrash, faPencilAlt, faShoppingCart } from "@fortawesome/free-solid-svg-icons";
...
//                           <p className="text-sm text-gray-700 truncate">{additionalInfo}</p>
//                           <div className="mt-2 flex justify-end space-x-2">
//                             <button
//                               onClick={handleEditInfo}
//                               className="text-yellow-500 hover:text-pink-700"
//                             >
//                               <FontAwesomeIcon icon={faPencilAlt} />
//                             </button>
//                             <button
//                               onClick={handleDeleteInfo}
//                               className="text-red-500 hover:text-pink-700"
//                             >
//                               <FontAwesomeIcon icon={faTrash} />
//                             </button>
//                           </div>
...
//                 className="w-full sm:w-auto bg-yellow-500 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg text-sm sm:text-lg font-semibold hover:bg-yellow-600 flex items-center space-x-2"
//               >
          ...
          <div className="mt-8 sm:mt-12">
                    ...
                    {(designFile || cartItem?.design_file) && (
                      <div className="mb-2 flex items-center">
                        ...
                        <button
                          ...
                          className="ml-2 text-red-500 hover:text-red-700"
                        >
                          <Image src="/icons/trash-2.png" alt="Delete" width={16} height={16} />
                        </button>
                      </div>
                    )}
                    {additionalInfo && (
            ...
            <div className="flex justify-end mt-4 sm:mt-6">
              <button
                ...
                className="w-full sm:w-auto bg-yellow-500 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg text-sm sm:text-lg font-semibold hover:bg-yellow-600 flex items-center space-x-2"
              >
                <Image src="/icons/shopping-cart.png" alt="Cart" width={16} height={16} />
                <span>Proceed to Cart</span>
              </button>
            </div>
          </div>
