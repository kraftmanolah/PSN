...
//           return; // Exit if localStorage has valid data
//         }
//       }

//       // Step 2: Fetch from API if localStorage is empty or invalid
//       try {
...
//           return; // No details saved yet, let user input them
//         }
...
//           setDeliveryOption("delivery");
//           localStorage.setItem("deliveryDetails", JSON.stringify(data)); // Sync localStorage
//         }
//       } catch (err) {
...
export default function CartPage() {
  ...
  // useEffect hooks remain unchanged (omitted for brevity)
