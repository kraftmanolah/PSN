...
#     class Meta:
#         model = Product
#         fields = ['id', 'name', 'price', 'currency', 'description', 'product_description', 'colors', 'features', 'product_category', 'created_at', 'thumbnails', 'main_image', 'increment_step']  # Added increment_step
...
#     class Meta:
#         model = CartItem
#         fields = ['id', 'product', 'quantity', 'design_file', 'additional_info', 'color']

# class CartSerializer(serializers.ModelSerializer):
#     items = CartItemSerializer(many=True)
#     total = serializers.SerializerMethodField()  # Add total calculation
#     item_count = serializers.SerializerMethodField()  # Add item count
